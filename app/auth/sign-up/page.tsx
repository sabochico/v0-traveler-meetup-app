...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (loading) return
    if (!acceptedTerms) {
      setError("Please agree to Drift's Terms, Privacy Policy, and Community Guidelines before creating an account.")
      return
    }
    ...
    <div className="min-h-dvh bg-background flex flex-col film-grain overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col justify-center px-6 py-8">
        <div className="max-w-sm mx-auto w-full">
          ...
          <SocialAuthButtons emailLabel="Continue with email" onEmailClick={focusEmailSignUp} disabled={!acceptedTerms} />
